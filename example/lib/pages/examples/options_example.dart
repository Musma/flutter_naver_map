...
class NaverMapViewOptionsExample extends StatefulWidget {
  ...
  @override
  State<NaverMapViewOptionsExample> createState() => _NaverMapViewOptionsExampleState();
}

class _NaverMapViewOptionsExampleState extends State<NaverMapViewOptionsExample> {
  @override
  void initState() {
  ...
  NaverMapViewOptions prepareOptionChange(NaverMapViewOptions newOptions) {
    if (!indoorAvailable) {
      newOptions = newOptions.copyWith(indoorEnable: false, indoorLevelPickerEnable: false);
    }
  ...
  bool get indoorAvailable => options.mapType == NMapType.basic || options.mapType == NMapType.terrain;

  /// 경량 모드는 지도 유형이 navi가 아닌 경우만 가능합니다.
  bool get liteModeAvailable => options.mapType != NMapType.navi && options.mapType != NMapType.none;
          ...
          slivers: [
            SliverColumn([
              ...
              SelectorWithTitle("로고 위치",
                  ...
                  selector: (context) => EasyDropdown(
                      ...
                      onChanged: (v) => options = options.copyWith(logoAlign: v)))
            ]),
            sliverMultiSwitcherGrid([
              TextSwitcher(
                  ...
                  onChanged: (v) => options = options.copyWith(scaleBarEnable: v)),
              TextSwitcher(
                  title: "내 위치 버튼",
                  description: ".locationButtonEnable",
                  value: options.locationButtonEnable,
                  onChanged: (enable) {
                    void buttonEnable(bool v) => options = options.copyWith(locationButtonEnable: v);
                    if (!enable) {
                      buttonEnable(false);
                      return;
                    }
                    requestLocationPermission(context, onGranted: () => buttonEnable(true));
                  }),
              TextSwitcher(
                  title: "나침반",
                  description: ".compassEnable",
                  value: options.compassEnable,
                  onChanged: (v) => options = options.copyWith(compassEnable: v)),
              if (indoorAvailable)
                TextSwitcher(
                    title: "실내 지도",
                    description: ".indoorEnable",
                    value: options.indoorEnable,
                    onChanged: (v) => options = options.copyWith(indoorEnable: v)),
              if (indoorAvailable)
                TextSwitcher(
                    title: "실내 지도 레벨 피커",
                    description: ".indoorLevelPickerEnable",
                    value: options.indoorLevelPickerEnable,
                    onChanged: (v) => options = options.copyWith(indoorLevelPickerEnable: v)),
              if (liteModeAvailable)
                TextSwitcher(
                    title: "경량 모드",
                    description: ".liteModeEnable",
                    value: options.liteModeEnable,
                    onChanged: (v) => options = options.copyWith(liteModeEnable: v)),
              if (nightModeAvailable)
                TextSwitcher(
                    title: "야간 모드",
                    description: ".nightModeEnable",
                    value: options.nightModeEnable,
                    onChanged: (v) => options = options.copyWith(nightModeEnable: v)),
            ]),
            SliverColumn([
              if (options.indoorEnable)
                SelectorWithTitle("실내 지도 유지 반경",
                    ...
                    selector: (context) => EasySlider(
                        ...
                        onChanged: (v) => options = options.copyWith(indoorFocusRadius: v))),
              SelectorWithTitle("지도 명도",
                  ...
                  selector: (context) => EasySlider(
                      ...
                      onChanged: (v) => options = options.copyWith(lightness: v))),
              SelectorWithTitle("건물 3D 높이",
                  ...
                  selector: (context) => EasySlider(
                      ...
                      onChanged: (v) => options = options.copyWith(buildingHeight: v))),
              SelectorWithTitle("심볼 크기",
                  ...
                  selector: (context) => EasySlider(
                      ...
                      onChanged: (v) => options = options.copyWith(symbolScale: v))),
              SelectorWithTitle("심볼 원근 계수",
                  ...
                  selector: (context) => EasySlider(
                      ...
                      onChanged: (v) => options = options.copyWith(symbolPerspectiveRatio: v))),
            ]),
            ...
            sliverMultiSwitcherGrid([
              TextSwitcher(
                  ...
                  onChanged: (v) => options = options.copyWith(scrollGesturesEnable: v)),
              TextSwitcher(
                  title: "줌 제스처",
                  description: ".zoomGesturesEnable",
                  value: options.zoomGesturesEnable,
                  onChanged: (v) => options = options.copyWith(zoomGesturesEnable: v)),
              TextSwitcher(
                  title: "회전 제스처",
                  description: ".rotationGesturesEnable",
                  value: options.rotationGesturesEnable,
                  onChanged: (v) => options = options.copyWith(rotationGesturesEnable: v)),
              TextSwitcher(
                  title: "기울임 제스처",
                  description: ".tiltGesturesEnable",
                  value: options.tiltGesturesEnable,
                  onChanged: (v) => options = options.copyWith(tiltGesturesEnable: v)),
              TextSwitcher(
                  title: "멈춤 제스처",
                  description: ".stopGesturesEnable",
                  value: options.stopGesturesEnable,
                  onChanged: (v) => options = options.copyWith(stopGesturesEnable: v)),
              TextSwitcher(
                  title: "심볼 터치 소비",
                  description: ".consumeSymbolTapEvents",
                  value: options.consumeSymbolTapEvents,
                  onChanged: (v) => options = options.copyWith(consumeSymbolTapEvents: v)),
              TextSwitcher(
                  title: "로고 클릭",
                  description: ".logoClickEnable",
                  value: options.logoClickEnable,
                  onChanged: (v) => options = options.copyWith(logoClickEnable: v)),
            ]),
            SliverColumn([
              SelectorWithTitle("오버레이 및 심볼\n터치 반경",
                  ...
                  selector: (context) => EasySlider(
                      ...
                      onChanged: (v) => options = options.copyWith(pickTolerance: v))),
              SelectorWithTitle("스크롤 마찰 계수",
                  ...
                  selector: (context) => EasySlider(
                      ...
                      defaultValue: NaverMapViewOptions.defaultScrollGesturesFriction,
                      onChanged: (v) => options = options.copyWith(scrollGesturesFriction: v))),
              SelectorWithTitle("줌 마찰 계수",
                  ...
                  selector: (context) => EasySlider(
                      ...
                      defaultValue: NaverMapViewOptions.defaultZoomGesturesFriction,
                      onChanged: (v) => options = options.copyWith(zoomGesturesFriction: v))),
              SelectorWithTitle("회전 마찰 계수",
                  ...
                  selector: (context) => EasySlider(
                      ...
                      defaultValue: NaverMapViewOptions.defaultRotationGesturesFriction,
                      onChanged: (v) => options = options.copyWith(rotationGesturesFriction: v))),
            ]),
            ...
            sliverMultiSwitcherGrid([
              ...
              layerGroupTextSwitcher("대중교통", NLayerGroup.transit, enable: options.mapType != NMapType.navi),
              layerGroupTextSwitcher("자전거", NLayerGroup.bicycle, enable: options.mapType != NMapType.navi),
              layerGroupTextSwitcher("등산정보", NLayerGroup.mountain, enable: options.mapType != NMapType.navi),
              layerGroupTextSwitcher("지적편집도", NLayerGroup.cadastral, enable: options.mapType != NMapType.navi),
            ], small: true),
            ...
            SliverColumn([
              SelectorWithTitle("최소 줌 제한",
                  ...
                  selector: (context) => EasySlider(
                      ...
                      onChanged: (v) => options = options.copyWith(minZoom: v))),
              SelectorWithTitle("최대 줌 제한",
                  ...
                  selector: (context) => EasySlider(
                      ...
                      onChanged: (v) => options = options.copyWith(maxZoom: v))),
              SelectorWithTitle("최대 기울임 제한",
                  ...
                  selector: (context) => EasySlider(
                      ...
                      onChanged: (v) => options = options.copyWith(maxTilt: v))),
            ]),
  ...
  Widget sliverMultiSwitcherGrid(List<TextSwitcher> switchers, {bool small = false}) {
  ...
  TextSwitcher layerGroupTextSwitcher(String title, NLayerGroup layer, {bool enable = true}) {
    return TextSwitcher(
        title: title,
  ...
  void requestLocationPermission(BuildContext context, {required void Function() onGranted}) {
    AlertUtil.openAlertIfResultTrue("위치 권한이 없습니다.\n위치를 가져오려면 권한을 허용해주세요.", context: context, callback: () async {
